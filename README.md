...
| **Module Sources** | `dartvel add <source>` will resolve a Swift package, a Maven artifact, a crate, an npm package or an OpenAPI document into a module. The lockfile pins a foreign source and the graph reports it; the resolver does not exist | ⚠️ Partial |
