      ...
      return WatchModels<Product>(
        ...
        builder: (BuildContext context, List<Product>? coffees) {
          ...
          final Product? coffee =
              coffees.where((Product c) => c.slug == slug).firstOrNull;
          if (coffee == null) {
            return ShopScroll(children: <Widget>[
              EmptyState(
                icon: Icons.search_off,
                title: 'That coffee has sold out',
                message: 'It is not on the shelf any more. Have a look at '
          ...
          final Widget details = DVBox.list([
            ...
            DVBox.wrapLine([
              CoffeeFact('Roast', '${coffee.roast[0].toUpperCase()}${coffee.roast.substring(1)}'),
            ...
            DVBox.row([
              ...
              Expanded(
                child: FilledButton(
                  ...
                  onPressed: () {
                    updateCart((Cart cart) => cart.add(coffee.slug, quantity.read()));
                    ScaffoldMessenger.of(context)
                      ..hideCurrentSnackBar()
                      ..showSnackBar(SnackBar(
                        content: Text('${quantity.read()} × ${coffee.name} added to your bag'),
          ...
          return ShopScroll(children: <Widget>[
            if (wide)
              ...
              ], spacing: 40, crossAlign: DVCrossAlign.start)
            else ...<Widget>[
              BagArt(coffee, height: 260, large: true),
              details,
            ],
          ]);
        },
