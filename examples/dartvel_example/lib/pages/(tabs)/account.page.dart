  ...
  return ShopScroll(
    ...
    children: <Widget>[
      ...
      if (account.signedIn)
          ...
          DVBox.row(
            [
              DVBox(
                ...
                ).modifier(p.title.color(p.onAccent)),
              ).modifier(
                const DVModifier()
                    .width(52)
                    .height(52)
        ...
        ], spacing: 16).modifier(cardStyle(p, padding: 18))
      else
        DVBox.list([
          const DVText('Sign in to order').modifier(p.title.semanticHeading(2)),
          const DVText(
            'Follow your orders from the roaster to your door, and '
