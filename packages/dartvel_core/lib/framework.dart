...
// dartvel.capture as the build and the generated server read it, and the
// runtime that runs it all. An application writes @DVModel(capture: true)
// and the pubspec, never these.
