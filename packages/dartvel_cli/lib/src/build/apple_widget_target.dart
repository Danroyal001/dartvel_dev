...
final String _xcconfigRefId = _id('000000000011');

/// The file the extension's configurations are based on.
const String dvAppleWidgetXcconfigFile = '$dvAppleWidgetExtensionName.xcconfig';

/// The extension's base configuration: Flutter's generated build settings,
/// which define the FLUTTER_BUILD_NAME and FLUTTER_BUILD_NUMBER its Info.plist
/// reads. Without them both are empty, the extension has no version, and a
/// simulator refuses to install the whole application ("Failed to create app
/// extension placeholder ... Invalid placeholder attributes").
///
/// Only the generated settings, not the application's Debug.xcconfig, which
/// pulls in the application's CocoaPods settings and would link its pods
/// into the extension.
String dvAppleWidgetXcconfig(String platform) => '''
// GENERATED by dartvel build. Do not edit: the next build writes it again.
#include "${platform == 'ios' ? '../Flutter/Generated.xcconfig' : '../Flutter/ephemeral/Flutter-Generated.xcconfig'}"
''';
...
String dvApplePbxprojWithWidgets(
  ...
  out = _beforeSectionEnd(out, 'PBXFileReference', <String>[
    ...
    '\t\t$_entitlementsRefId /* $_entitlements */ = {isa = PBXFileReference; '
        ...
        'sourceTree = "<group>"; };',
    '\t\t$_xcconfigRefId /* $dvAppleWidgetXcconfigFile */ = '
        '{isa = PBXFileReference; lastKnownFileType = text.xcconfig; '
        'path = $dvAppleWidgetXcconfigFile; sourceTree = "<group>"; };',
  ]);
  ...
  List<String> configuration(String id, String name) => <String>[
        ...
        '\t\t\tbaseConfigurationReference = $_xcconfigRefId '
            '/* $dvAppleWidgetXcconfigFile */;',
        '\t\t\tbuildSettings = {',
