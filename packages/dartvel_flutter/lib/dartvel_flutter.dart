...
export 'package:dartvel_core/dartvel.dart'
    show
        ...
        DVTransform,
        DVVec3,
        // XR: presenting a scene in space -- capability, poses, anchors, the
        // device adapter and its headless device, and the session runtime.
        DVAnchor,
        DVAnchorType,
        DVComfort,
        DVComfortOptions,
        ...
        DVImmersion,
        DVLocomotion,
        DVMemorySpatialAnchorStore,
        DVPlane,
        DVSceneAnchorPlacement,
        DVSpatialAnchorNotStored,
        DVSpatialAnchorStatus,
        DVSpatialAnchorStore,
        DVSpatialCapability,
        DVSpatialConsent,
        DVSpatialConvention,
        DVSpatialDataUse,
        ...
        DVSpatialInput,
        DVSpatialInputAction,
        DVSpatialInputEvent,
        DVSpatialInputSource,
        DVSpatialLighting,
        DVSpatialLightProbe,
        DVSpatialPersistence,
        DVSpatialPersistenceKind,
        DVSpatialPose,
        DVSpatialPresentation,
        DVSpatialRefusal,
        DVSpatialSession,
        DVSpatialSessionState,
        DVSpatialSpaceKind,
        DVSpatialSpaceRequest,
        DVVolumeOptions,
        DVXRAnchorChanged,
        DVXRBindingException,
        DVXRDevice,
        DVXRDeviceEvent,
        DVXRDiagnosticSink,
        DVXRFakeDevice,
        ...
        DVXRHeadPoseChanged,
        DVXRInput,
        DVXRPassthroughChanged,
        DVXRPermissionRevoked,
        DVXRRuntime,
        DVXRSpaceEnded,
        DVXRTrackingChanged,
        dvLogXRDiagnostic,
        ...
        DVDatabase,
        DVDatabaseAdapter,
        // Storage-Neutral Records: what framework code persists through.
        DVAllFilter,
        DVAnyFilter,
        DVCompare,
        DVFieldFilter,
