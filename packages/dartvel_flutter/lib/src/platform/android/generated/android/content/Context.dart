...
extension Context$$Methods on Context {
  ...
  static final _id_set$theme = Context._class.instanceMethodId(
    r'setTheme',
    r'(I)V',
  );
  ...
  static final _id_get$theme$1 = Context._class.instanceMethodId(
    r'getTheme',
    r'()Landroid/content/res/Resources$Theme;',
  );

  static final _get$theme$1 =
      jni$_.ProtectedJniExtensions.lookup<
            jni$_.NativeFunction<
              jni$_.JniResult Function(
                jni$_.Pointer<jni$_.Void>,
  ...
  /// The returned object must be released after use, by calling the [release] method.
  typedarray$_.TypedArray? obtainStyledAttributes$3(
    attributeset$_.AttributeSet? attributeSet,
    jni$_.JIntArray? is$,
    core$_.int i,
    core$_.int i1,
  ...
  /// The returned object must be released after use, by calling the [release] method.
  $T? getSystemService$1<$T extends jni$_.JObject?>(jni$_.JClass? class$) {
    final _$$selfRef = reference;
  ...
  /// The returned object must be released after use, by calling the [release] method.
  Context? createWindowContext(core$_.int i, bundle$_.Bundle? bundle) {
    final _$$selfRef = reference;
    final _$bundle = bundle?.reference ?? jni$_.jNullReference;
