...
const List<(String, String, String)> shipped = <(String, String, String)>[
  ...
  (
    ...
    '`dartvel build web-server` makes one file that runs your backend and web '
        'app on Linux, macOS or Windows. It creates its SQLite database '
...
const List<(String, String, String)> partial = <(String, String, String)>[
  ...
  (
    ...
    'Present: DV.Updates.check, apply and rollback run on the Shorebird '
        'updater. Patches publish into your own web-server binary with '
        '`dartvel updates patch --patch-source`, and CI patches an Android release that '
  ...
  (
    ...
    'Present: release gates that roll back on a regression. Absent: '
        '`dartvel ci init`.',
  ),
  (
  ...
  (
    ...
    'Tizen, webOS, eLinux',
    'Present: Tizen, VS Code and Sony eLinux release builds. Absent: '
        '`dartvel build webos`, whose embedder ships Dart 3.10.9, and Fuchsia.',
  ),
  (
